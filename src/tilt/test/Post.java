    ...
    */
        ...
        HttpServletResponse response, String urn ) throws TiltException
    {
        try
        {
            ...
            doc.getHead().addScriptFile( "/tilt/static/jquery-1.11.1.js" );
            doc.getHead().addScriptFile( "/tilt/static/jquery.highlight.js" );
            doc.getHead().addScriptFile( "/tilt/static/post.js" );
